...
FROM
    (
    SELECT
    timestamp, toStartOfSecond(toDateTime64(timestamp / 1000000, 3)) AS second_ts, `asks[0].price`, `asks[0].amount`, `bids[0].price`, `bids[0].amount`, `asks[1].price`, `asks[1].amount`, `bids[1].price`, `bids[1].amount`, `asks[2].price`, `asks[2].amount`, `bids[2].price`, `bids[2].amount`, `asks[3].price`, `asks[3].amount`, `bids[3].price`, `bids[3].amount`, `asks[4].price`, `asks[4].amount`, `bids[4].price`, `bids[4].amount`, `asks[5].price`, `asks[5].amount`, `bids[5].price`, `bids[5].amount`, `asks[6].price`, `asks[6].amount`, `bids[6].price`, `bids[6].amount`, `asks[7].price`, `asks[7].amount`, `bids[7].price`, `bids[7].amount`, `asks[8].price`, `asks[8].amount`, `bids[8].price`, `bids[8].amount`, `asks[9].price`, `asks[9].amount`, `bids[9].price`, `bids[9].amount`, `asks[10].price`, `asks[10].amount`, `bids[10].price`, `bids[10].amount`, `asks[11].price`, `asks[11].amount`, `bids[11].price`, `bids[11].amount`, `asks[12].price`, `asks[12].amount`, `bids[12].price`, `bids[12].amount`, `asks[13].price`, `asks[13].amount`, `bids[13].price`, `bids[13].amount`, `asks[14].price`, `asks[14].amount`, `bids[14].price`, `bids[14].amount`, `asks[15].price`, `asks[15].amount`, `bids[15].price`, `bids[15].amount`, `asks[16].price`, `asks[16].amount`, `bids[16].price`, `bids[16].amount`, `asks[17].price`, `asks[17].amount`, `bids[17].price`, `bids[17].amount`, `asks[18].price`, `asks[18].amount`, `bids[18].price`, `bids[18].amount`, `asks[19].price`, `asks[19].amount`, `bids[19].price`, `bids[19].amount`, `asks[20].price`, `asks[20].amount`, `bids[20].price`, `bids[20].amount`, `asks[21].price`, `asks[21].amount`, `bids[21].price`, `bids[21].amount`, `asks[22].price`, `asks[22].amount`, `bids[22].price`, `bids[22].amount`, `asks[23].price`, `asks[23].amount`, `bids[23].price`, `bids[23].amount`, `asks[24].price`, `asks[24].amount`, `bids[24].price`, `bids[24].amount`, row_number() OVER (PARTITION BY toStartOfSecond(toDateTime64(timestamp / 1000000, 3)) ORDER BY timestamp DESC) AS rn
    FROM
