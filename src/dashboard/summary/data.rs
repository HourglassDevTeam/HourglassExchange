    ...
    fn update_data_summary_with_position()
    {
        ...
        let test_cases = vec![TestCase { // Test case 0
                                         ...
                                         expected_summary: DataSummary { count: 1,
                                                                         sum: 1.1,
                                                                         mean: 1.1,
                                                                         dispersion: Dispersion { range: Range { activated: true, high: 1.1, low: 1.1 },
                              ...
                              TestCase { // Test case 1
                                         ...
                                         expected_summary: DataSummary { count: 2,
                                                                         sum: 2.3,
                                                                         mean: (2.3 / 2.0),
                                                                         dispersion: Dispersion { range: Range { activated: true, high: 1.2, low: 1.1 },
                              ...
                              TestCase { // Test case 2
                                         ...
                                         expected_summary: DataSummary { count: 3,
                                                                         sum: (2.3 + 1.3),
                                                                         mean: (3.6 / 3.0),
                                                                         dispersion: Dispersion { range: Range { activated: true, high: 1.3, low: 1.1 },
