use crate::common_skeleton::datafeed::{Feed, FeedGenerator};
...
impl<Iter, Event> FeedGenerator<Event> for MarketFeed<Iter, Event> where Iter: Iterator<Item = Event>
{
...
{
    /// 从 `IntoIterator`构造一个产生市场事件的、历史的 [`MarketFeed`] 。
